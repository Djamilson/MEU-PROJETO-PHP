...
<div class="custom-calendar no-select" data-lang="pt-BR">
    ...
    <input type="text" name="birth_date" class="date-picker-input" placeholder="Selecione a data" autocomplete="off">
...
<button type="button" class="btn-danger btn-icon-left" title="Cancelar" id="newUserCloseDrawerBtn">
